        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <main className="col-span-1 lg:col-span-3 bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 rounded-feature p-6 sm:p-10 shadow-sm space-y-8 text-sm leading-relaxed text-neutral-700 dark:text-neutral-300 font-medium">
            ...
            <section id="acceptance" className="space-y-3 scroll-mt-24">
              ...
              <p>
                These terms constitute a legally binding agreement between you ("Customer", "User", or "You") and Yathu Arokiyagam. If you do not agree to these terms, please do not access or use our services.
              </p>
            </section>
            ...
            <section id="intellectual" className="space-y-3 scroll-mt-24">
              ...
              <p>
                All graphics, brand logo designs, text content, database schemas, and custom code on this site are the intellectual property of Yathu Arokiyagam, protected by copyright and international intellectual property laws.
              </p>
            </section>
            ...
            <section id="liability" className="space-y-3 scroll-mt-24">
              ...
              <p>
                Yathu Arokiyagam is not liable for any indirect, incidental, or consequential damages arising from your use of the website or consumption of products, to the maximum extent permitted by applicable laws.
              </p>
            </section>
            ...
            <section id="contact" className="space-y-3 scroll-mt-24 border-t border-neutral-100 dark:border-neutral-800 pt-8">
              ...
              <div className="bg-neutral-50 dark:bg-neutral-950 p-4 rounded-card border border-neutral-150 dark:border-neutral-850 text-xs space-y-1">
                <p>Legal Counsel Email: <span className="font-bold text-primary-500">yathuarokiyagam@gmail.com</span></p>
                <p>Support Hotline: +91-88701-59766</p>
              </div>
            </section>
