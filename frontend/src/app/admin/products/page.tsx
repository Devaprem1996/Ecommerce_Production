        ...
        <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
          <div className="relative w-full md:w-auto">
            ...
            <select
              ...
              className="w-full md:w-auto text-base md:text-xs font-bold pl-10 pr-8 py-2.5 md:py-2 bg-white dark:bg-neutral-900 border rounded-card text-neutral-805 dark:text-white focus:outline-none cursor-pointer"
            >
              {categories.map(cat => (
            ...
            <div key={prod.id} className="bg-white dark:bg-neutral-900 border border-neutral-150 dark:border-neutral-850 rounded-feature p-4 shadow-sm space-y-3">
              <div className="flex items-center gap-3">
                <img 
                  src={prod.images[0] || 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?auto=format&fit=crop&q=80&w=400'} 
                  alt={prod.name} 
                  className="w-12 h-12 rounded-card object-cover border"
                />
