...
export default function AdminSettingsPage() {
  ...
  const { register, handleSubmit, watch, formState: { errors: rawErrors, isDirty } } = useForm<any>({
    ...
    defaultValues: {
      ...
      siteTagline: "A Dedicated Store For Those Who Choose A Healthy Lifestyle",
      ...
      contactEmail: "yathuarokiyagam@gmail.com",
      contactPhone: "+91 88701 59766",
      whatsappNumber: "+91 88701 59766",
      businessAddress: "#402, Seepalakottai Road, Chinnmanur, Theni District, Tamil Nadu - 625515",
      ...
      smtpPort: 587,
      smtpUsername: "postmaster@yathuarokiyagam.com",
      smtpPassword: "smtpSecretPassword123!",
      fromEmail: "orders@yathuarokiyagam.com",
      fromName: "Yathu Arokiyagam Store",

      smsProvider: "twilio",
      smsApiKey: "SKdf80sh3jkf29hs81j3k9f02s",
      smsSenderId: "YATHUI",

      defaultMetaTitle: "Yathu Arokiyagam - Healthy & Traditional Food, Order Online",
      defaultMetaDescription: "Buy honest, unadulterated traditional rices, millets, wood-pressed oils, and natural sweeteners from the dedicated Yathu Arokiyagam store. Zero adulteration, zero preservatives.",
      googleAnalyticsId: "G-AETH99XX",
      facebookPixelId: "FB-PX-12345",
      robotsTxt: "User-agent: *\nDisallow: /admin\nDisallow: /api",

      facebookUrl: "https://facebook.com/yathuarokiyagam",
      instagramUrl: "https://instagram.com/yathuarokiyagam",
      twitterUrl: "https://twitter.com/yathuarokiyagam",
      youtubeUrl: "https://youtube.com/yathuarokiyagam",
