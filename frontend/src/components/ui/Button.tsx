...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary:
      "bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 focus:ring-indigo-500 shadow-md shadow-indigo-100",
    secondary:
    ...
    danger:
      "bg-red-600 text-white hover:bg-red-700 focus:ring-red-500 shadow-md shadow-red-100",
