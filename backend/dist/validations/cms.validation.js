...
exports.updateProductSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        descriptionEn: zod_1.z.string().trim().optional(),
        descriptionTa: zod_1.z.string().trim().optional(),
        thumbnailUrl: zod_1.z.string().trim().url("Invalid thumbnail URL").optional().or(zod_1.z.literal("")).or(zod_1.z.string().startsWith("/")).nullable(),
        isActive: zod_1.z.boolean().optional(),
        price: zod_1.z.number().positive("Price must be positive").optional(),
        originalPrice: zod_1.z.number().positive().optional().nullable(),
